...
| `loan_percent_income` | decimal | preditora original | Percentual da renda comprometido pelo empréstimo. |
...
| `comprometimento_renda` | decimal | engenharia | Nova coluna exigida: `(loan_amnt / person_income) * 100`. |
...
Idade máxima de 144 e tempo de emprego máximo de 123 foram marcados para investigação. Eles não são removidos automaticamente nesta fase.
